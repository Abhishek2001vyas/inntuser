...
class Verify_pay extends StatefulWidget {
  final otp;
  final mobile;
final id;
final amount;
final reid;
  ...
  const Verify_pay({
    super.key,
    this.otp,
    this.mobile, this.id, this.amount, this.reid,

  });

  @override
  State<Verify_pay> createState() => _Verify_payState();
}

class _Verify_payState extends State<Verify_pay> {
  final Verifyapi1 = Get.put(Getdatafromqr_api());
             ...
             Center(
              ...
              //       :
                    ...
                    onPressed: _isVerifyButtonEnabled
                      ...
                      Verifyapi1.verifypay(widget.id,_otpController.text.toString(),widget.amount,widget.reid);
                    }
                        : null,
                    child:
