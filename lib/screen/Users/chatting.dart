          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  boxShadow: const [
                    BoxShadow(color: logocolo, blurRadius: 0.5)
                  ]),
              child: ClipRRect(
                borderRadius: BorderRadius.circular(50),
                child: widget.venderimage != null
                    ? Image.network(
            ...
            widget.status == 1
                ? GestureDetector(
                    onTap: () {
                      Get.to(SellerDetails(   sourceName: "0",
                        shopid: widget.venderid,
                        shopanme: widget.shopname,
                      ));
                    },
                    child: Image.asset(
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
              ...
              child: StreamBuilder(
                stream: Stream.periodic(const Duration(
                  milliseconds: 0,
                    ...
                    chat_api.uservenderchat(widget.venderid, widget.status)),
                builder: (context, snapshot) {
                  return snapshot.hasData == "true" ||
                          chat_api.uservenderchatlist.isEmpty
                      ? const Padding(
                      ...
                      : ListView.builder(
                          ...
                          itemCount:
                              chat_api.uservenderchatlist[0]["data"].length,
                          itemBuilder: (context, index) {
                            //---------------------------------------Date Time -------------------------------------//

                            var dt = chat_api.uservenderchatlist[0]["data"]
                                    [index]["createdAt"]
                                .toString()
                                .substring(0, 10);
                            if (datematch.toString() !=
                              ...
                              if (dt.toString().substring(0, 10) ==
                                ...
                                newDate = "Today";
                                datematch = dt.toString().substring(0, 10);
                                isSameDate = false;
                              } else if (dt.toString().substring(0, 10) ==
                                  DateTime.now()
                                ...
                                newDate = dt.toString().substring(0, 10);
                                datematch = dt.toString().substring(0, 10);
                                isSameDate = false;
                              }
                              print(
                            ...
                            var findvideo1 = chat_api.uservenderchatlist
                                .elementAt(0)["data"][index]["text"]
                                .split('.')
                                .last
                                .toLowerCase();
                            print("texttype ${ chat_api.uservenderchatlist
                                .elementAt(0)["data"][index]["text"]}");
                            print("$findvideo1");
                            ...
                            return Column(
                              children: [
                                ...
                                if (newDate != null && isSameDate == false)
                                  Center(
                                      child: Text(
                                    newDate,
                                    style: TextStyle(color: Colors.grey),
                                  )),
                                if (chat_api.uservenderchatlist
                                                .elementAt(0)["data"][index]
                                                    ["send_status"]
                                                .toString() ==
                                            "Received" &&
                                        findvideo1 == "mp4" ||
                                  ...
                                  VideoWithImagePlaceholder(
                                    videoUrl:
                                        "$image_url${chat_api.uservenderchatlist.elementAt(0)["data"][index]["text"].toString()}",
                                    no: 1,
                                  ),]
                               else if (chat_api.uservenderchatlist
                                                .elementAt(0)["data"][index]
                                                    ["send_status"]
                                                .toString() ==
                                            "Sent" &&
                                  ...
                                  Padding(
                                    ...
                                    child: VengamoChatUI(
                                        ...
                                        isAudio: true,
                                        audioSource:
                                            '$image_url${chat_api.uservenderchatlist.elementAt(0)["data"][index]["text"]}',
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                   child: audioviewchat(link: chat_api.uservenderchatlist.elementAt(0)["data"][index]["text"],)
                                   // VengamoChatUI(
                                   //     senderBgColor: logocolo,
                                   //     receiverBgColor: logocolo,
                                   //     isSender: true,
                                ...
                                ,]
                                  ...
                                  //     )),
                                            ...
                                            .toString() ==
                                        "1" ||
                                    chat_api.uservenderchatlist
                                            .elementAt(0)["data"][index]
                                                ["send_status"]
                                            .toString() ==
                                        "Sent")...[
                                  BubbleNormal(
                                    text: chat_api.uservenderchatlist
                                        .elementAt(0)["data"][index]["text"]
                                        .toString(),
                                    ...
                                    sent: true,
                                    seen: true,
                                    delivered: chat_api.uservenderchatlist
                                                .elementAt(0)["data"][index]
                                                    ["status"]
                                                .toString() ==
                                            "1".toString()
            ...
            MessageBar(
              onSend: (p0) async {
                await chat_api.chatsendlist(
                    widget.venderid, p0.toString(), widget.status);
                _scrollToBottom();
              },
              actions: [
                Row(
...
// Define the _playPauseButtonClick function
  ...
  Future cam() async {
    ...
    if (image != null) {
      ...
      findvideo = chat_api.imagePath.split('.').last.toLowerCase();
      Get.to(Pickview(
        shopname: widget.shopname,
        shopid: widget.venderid,
        shopimage: widget.venderimage,
  ...
  Future audieo() async {
    ...
    if (image != null) {
      ...
      findvideo = chat_api.imagePath.split('.').last.toLowerCase();
      print('findtype ${file.path!.toString()}    ${findvideo}');
  ...
  Future file() async {
    var image = await FilePicker.platform.pickFiles(
      type: FileType.any, // Specify that you want to pick audio files
    );
    if (image != null) {
      PlatformFile file = image.files.first;
      chat_api.imagePath.value = file.path!.toString();
...
class audioviewchat extends StatefulWidget {
  final link;
  const audioviewchat({super.key, this.link});
        ...
        children: [
          findvideo == "mp3"
              ? SizedBox(
                  ...
                  child: AudioPlayerScreen(
                    urlpath: chat_api.imagePath.value,
                  ))
              : findvideo == "mp4" ||
                      findvideo == "mov" ||
                      findvideo == "avi" ||
          ...
          findvideo == "pdf" ||
              ...
              Container(
                  height: h,
                  width: w,
                  child:Center(child: Image.asset("assets/images/document.png"))
              ):
          ...
          Obx(() => Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: FileImage(
                                    File(chat_api.imagePath.toString())))),
                      )),
          Positioned(
              left: 5,
              top: h / 30,
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                ...
                Obx(() => chat_api.loading == true
                    ? const Center(
                        child: CircularProgressIndicator(color: logocolo),
                      )
                    : IconButton(
                        onPressed: () async {
                          await chat_api.chatimageapi(
                              widget.shopid,
                              chat_api.imagePath.value.toString(),
                              widget.shopname,
                              widget.shopimage,
                              widget.status);
                        },
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                const Center(
                  child: Icon(Icons.audiotrack_outlined, size: 30),
                ),
                Center(
                  child: _isPlaying
                      ? IconButton(
