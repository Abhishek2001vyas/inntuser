...
class Verify_updatemobile extends StatefulWidget {
  final otp;
  final mobile;


  const Verify_updatemobile({
    super.key,
    this.otp,
    this.mobile,
  ...
  @override
  State<Verify_updatemobile> createState() => _Verify_updatemobileState();
}

class _Verify_updatemobileState extends State<Verify_updatemobile> {
  final Verifyapi = Get.put(updateprofileapi());
            ...
            /*  Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                minimumSize: Size.square(40), backgroundColor: Colors.white,
              ...
              ElevatedButton(
                  ...
                  onPressed: _isVerifyButtonEnabled
                    ...
                    Verifyapi.updatemobileverfiyotp( _otpController.text.toString());
                  }
                      : null,
                  child:
