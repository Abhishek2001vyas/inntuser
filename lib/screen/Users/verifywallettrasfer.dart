...
class Verify_wallettrasfer extends StatefulWidget {
  final otp;
  final mobile;
  // final id;
  final amount;
  ...
  const Verify_wallettrasfer({
    super.key,
    this.otp,
    this.mobile, this.amount, this.reid,

  });

  @override
  State<Verify_wallettrasfer> createState() => _Verify_wallettrasferState();
}

class _Verify_wallettrasferState extends State<Verify_wallettrasfer> {
  final Verifyapi1 = Get.put(wallet_api());
            ...
            children: [
              ...
              ElevatedButton(
                  ...
                  onPressed: _isVerifyButtonEnabled
                    ...
                    Verifyapi1.verifypay(_otpController.text.toString(),widget.amount,widget.reid);
                  }
                      : null,
                  child:
