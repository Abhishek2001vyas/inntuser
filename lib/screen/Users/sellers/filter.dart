...
class Sellerfilter extends StatefulWidget {
  final higher;
  final lower;
  const Sellerfilter({super.key, this.higher, this.lower});

  @override
  State<Sellerfilter> createState() => _SellerfilterState();
}

class _SellerfilterState extends State<Sellerfilter> {
      ...
      child: Container(
        ...
        child: ElevatedButton(
          onPressed: () async {
            ...
            //   print("sdgsdgsg  ${selectedIndices3.toString()}");
            await homeapi.allsellerfilter(
