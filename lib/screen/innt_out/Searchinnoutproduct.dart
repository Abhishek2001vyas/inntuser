...
class HomeSearchinnout extends StatefulWidget {
  const HomeSearchinnout({super.key});

  @override
  State<HomeSearchinnout> createState() => _HomeSearchinnoutState();
}

class _HomeSearchinnoutState extends State<HomeSearchinnout> {
        ...
        title: SizedBox(
          ...
          child: TextFormField(
            ...
            onChanged: (value) async {
              await homeapi.inntout_prodfilter(value);
            },
        ...
        child: Column(
          children: [
            ...
            Obx(() => homeapi.loading == true
                ...
                : homeapi.inntoutprof.isNotEmpty && search.text.isNotEmpty
                    ? GridView.builder(
                        gridDelegate:
                        ...
                        shrinkWrap: true,
                        itemCount:
                            homeapi.inntoutprof.elementAt(0)["data"]!.length,
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: () {
                              Get.to(() => Product_deatils(
                                    sourceName: "0",
                                    shopid: homeapi.inntoutprof
                                        .elementAt(0)["data"]!
                                        .elementAt(index)["venderId"]
                                        .toString(),
                                    subsubcateid: homeapi.inntoutprof
                                        .elementAt(0)["data"]!
                              ...
                              child: Column(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.network(
                                      "$image_url${homeapi.inntoutprof.elementAt(0)["data"]!.elementAt(index)["image1"].toString()}",
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      width: w / 4,
                                      child: Text(
                                        "\$${homeapi.inntoutprof.elementAt(0)["data"]!.elementAt(index)["sale_price"].toString()}",
                                        overflow: TextOverflow.ellipsis,
                                        style: const TextStyle(
                                          fontSize: 15,
                    ...
                    //   },
                    // ) :
                    homeapi.inntoutprof.isEmpty && search.text.isNotEmpty
                        ? const Text(
                            "No product",
