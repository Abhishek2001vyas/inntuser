...
class kidzFilter extends StatefulWidget {
  final shopid;
  final higher;
  final lower;
  const kidzFilter({Key? key, this.higher, this.lower, this.shopid})
      : super(key: key);

  @override
  State<kidzFilter> createState() => _kidzFilterState();
}

class _kidzFilterState extends State<kidzFilter> {
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: ElevatedButton(
          onPressed: () async {
            await homeapi.sellerdeatils_prodfilter(
